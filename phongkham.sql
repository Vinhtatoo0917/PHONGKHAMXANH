...
--
-- Host: localhost:3306
-- Generation Time: May 24, 2026 at 04:35 PM
...
(12, 12, 1, 1, 150000.00, 150000.00, NULL, 'confirmed'),
(13, 13, 1, 1, 150000.00, 150000.00, NULL, 'confirmed'),
(14, 14, 1, 1, 150000.00, 150000.00, NULL, 'confirmed');
...
(10, 9, 2, 'completed', 'bình thường', '120mg', NULL, '2026-05-24 02:12:43');
...
(3, 3, 'dich_vu', 1, 'Khám Nội tổng quát', 1, 150000.00, 150000.00),
(4, 4, 'dich_vu', 1, 'Khám Nội tổng quát', 1, 150000.00, 150000.00),
(5, 5, 'dich_vu', 1, 'Khám Nội tổng quát', 1, 150000.00, 150000.00);
...
(6, 11, 3, '2026-05-23 07:30:52'),
(7, 12, 3, '2026-05-23 07:33:25'),
(8, 14, 3, '2026-05-24 02:13:26');
...
(1, 1, 9, NULL, 'khám_ngoại_trú', 150000.00, 0.00, 150000.00, 'paid', '2026-05-22 13:16:48'),
(3, 2, 11, NULL, 'khám_ngoại_trú', 150000.00, 0.00, 150000.00, 'paid', '2026-05-23 07:30:52'),
(4, 1, 12, NULL, 'khám_ngoại_trú', 150000.00, 0.00, 150000.00, 'paid', '2026-05-23 07:33:25'),
(5, 2, 14, NULL, 'khám_ngoại_trú', 150000.00, 0.00, 150000.00, 'paid', '2026-05-24 02:13:26');
...
(5, 11, 3, '2', 'viêm', 'ho liên tục', 'Kê đơn thuốc', '2026-05-23 07:30:52'),
(6, 12, 3, '5', 'đái', 'đái', 'Kê đơn thuốc', '2026-05-23 07:33:25'),
(7, 14, 3, '1', 'cảm lạnh', 'sốt', 'Kê đơn thuốc', '2026-05-24 02:13:26');
...
(2, 1, 2, 'completed', 'unpaid', 150000.00, NULL, NULL, NULL, 5),
(3, 2, 2, 'rejected', 'unpaid', 150000.00, NULL, NULL, NULL, 5),
(4, 2, 2, 'cancelled', 'unpaid', 150000.00, NULL, NULL, NULL, 5),
(5, 2, 2, 'cancelled', 'unpaid', 150000.00, NULL, NULL, NULL, 5),
(6, 2, 2, 'completed', 'unpaid', 150000.00, NULL, NULL, NULL, 5),
(7, 2, 1, 'confirmed', 'unpaid', 150000.00, NULL, NULL, NULL, 6),
(8, 2, 1, 'completed', 'unpaid', 150000.00, NULL, NULL, NULL, 8),
(9, 1, 2, 'completed', 'unpaid', 150000.00, NULL, NULL, NULL, 8),
(10, 3, 3, 'confirmed', 'unpaid', 150000.00, NULL, NULL, NULL, 8),
(11, 2, 1, 'completed', 'unpaid', 150000.00, '2026-05-23 06:08:03', NULL, NULL, 9),
(12, 1, 2, 'completed', 'unpaid', 150000.00, '2026-05-23 06:30:29', NULL, NULL, 9),
(13, 3, 3, 'examining', 'unpaid', 150000.00, '2026-05-23 06:49:22', NULL, NULL, 9),
(14, 2, 1, 'completed', 'unpaid', 150000.00, '2026-05-24 02:11:50', NULL, NULL, 10);
...
(4, '2026_05_24_000000_add_otp_columns_to_taikhoan', 2);
...
(9, 14, 5, '2026-05-24 02:12:12', 'completed', 'xét nghiệm máu');
...
CREATE TABLE `taikhoan` (
  ...
  `otp_reset_code` varchar(6) COLLATE utf8mb4_vietnamese_ci DEFAULT NULL,
  `otp_reset_expires_at` datetime DEFAULT NULL,
...
INSERT INTO `taikhoan` (`MaTaiKhoan`, `sdt`, `email`, `MatKhau`, `VaiTro`, `AccessToken`, `otp_reset_code`, `otp_reset_expires_at`, `trangthaihoatdong`, `dangnhaplancuoi`, `ngaytao`) VALUES
(1, 967287418, 'admin@gmail.com', '$2y$12$RiZER9gFTVPgGWFgvjW7LuPSkTUJZQe7N5rySokraR8FPYuiwXXiq', 'admin', NULL, NULL, NULL, 'active', '2026-05-24 16:27:29', '2026-05-02 10:38:38'),
(4, 934567890, 'checkin@gmail.com', '$2y$12$RiZER9gFTVPgGWFgvjW7LuPSkTUJZQe7N5rySokraR8FPYuiwXXiq', 'checkin', 'da837d4897afcfce83ee0483600b40c28722102cbff34e9cb6ea074e7d0ea7c4', NULL, NULL, 'active', '2026-05-23 04:59:28', '2026-05-02 10:38:38'),
(5, 945678901, 'thungan@gmail.com', '$2y$12$RiZER9gFTVPgGWFgvjW7LuPSkTUJZQe7N5rySokraR8FPYuiwXXiq', 'thungan', NULL, NULL, NULL, 'active', '2026-05-24 05:44:37', '2026-05-02 10:38:38'),
(7, 363455205, 'vinhtatoo0917@gmail.com', '$2y$12$bsQSBI8S7XggPwCKF4/zaOpijB8Pm6AuhCHEjv0F4mcsD4R8GFLJO', 'BenhNhan', '9270004b53196aed11c9afcc58b3a31281a131bbc1cc5e45eb6326921f9da1ab', NULL, NULL, 'active', '2026-05-24 07:19:15', '2026-05-06 07:41:26'),
(10, 363455203, 'kieuvi15112005@gmail.com', '$2y$12$RiZER9gFTVPgGWFgvjW7LuPSkTUJZQe7N5rySokraR8FPYuiwXXiq', 'bacsi', NULL, NULL, NULL, 'active', '2026-05-24 05:42:20', '2026-05-09 16:19:09'),
(11, 967287419, 'vinhtatoo0911@gmail.com', '$2y$12$RiZER9gFTVPgGWFgvjW7LuPSkTUJZQe7N5rySokraR8FPYuiwXXiq', 'bacsi', NULL, NULL, NULL, 'active', '2026-05-20 15:00:15', '2026-05-19 17:09:17'),
(12, 393653190, 'vinh123456@gmail.com', '$2y$12$RiZER9gFTVPgGWFgvjW7LuPSkTUJZQe7N5rySokraR8FPYuiwXXiq', 'BenhNhan', '66c8706206f727c5b9f6f41ff4ad7f835332d4da9bc38f2cd94b44ee1e66fc91', NULL, NULL, 'active', '2026-05-24 16:30:37', '2026-05-20 10:49:29'),
(13, 987654321, 'hoangvy@gmail.com', '$2y$12$RiZER9gFTVPgGWFgvjW7LuPSkTUJZQe7N5rySokraR8FPYuiwXXiq', 'bacsi', '4af478414b5005cf0960a86bb4c574b8930fdee2f9f19bf81f090f088f3db17c', NULL, NULL, 'active', '2026-05-24 02:11:18', '2026-05-20 15:37:40'),
(14, 123456789, 'dwadwad@gmail.com', '$2y$12$RiZER9gFTVPgGWFgvjW7LuPSkTUJZQe7N5rySokraR8FPYuiwXXiq', 'BenhNhan', NULL, NULL, NULL, 'active', '2026-05-23 12:45:43', '2026-05-22 13:41:35');
...
INSERT INTO `thanhtoan` (`MaThanhToan`, `MaHoaDon`, `MaThuNgan`, `SoTien`, `PhuongThuc`, `TrangThai`, `ThoiDiem`) VALUES
(1, 3, 1, 150000.00, 'vnpay', 'completed', '2026-05-24 01:56:24'),
(2, 5, NULL, 150000.00, 'vnpay', 'completed', '2026-05-24 02:44:53'),
(3, 1, NULL, 150000.00, 'cash', 'completed', '2026-05-24 03:18:58');
...
CREATE TABLE `vnpay_transactions` (
  ...
  `TrangThai` enum('pending','completed','failed') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'pending',
...
--
ALTER TABLE `chitietlichkham`
  MODIFY `MaChiTiet` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `chitietphieuchidinh`
--
ALTER TABLE `chitietphieuchidinh`
  MODIFY `MaChiTietPhieu` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT for table `ct_donthuoc`
--
ALTER TABLE `ct_donthuoc`
  MODIFY `MaChiTiet` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `ct_hoadon`
--
ALTER TABLE `ct_hoadon`
  MODIFY `MaChiTiet` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `donthuoc`
--
ALTER TABLE `donthuoc`
  MODIFY `MaDonThuoc` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
...
--
ALTER TABLE `hoadon`
  MODIFY `MaHoaDon` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `ketluankham`
--
ALTER TABLE `ketluankham`
  MODIFY `MaKetLuanKham` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `lichkham`
  MODIFY `MaLichKham` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `lichlamviec`
--
ALTER TABLE `lichlamviec`
  MODIFY `MaLichLamViec` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `phieuchidinh`
  MODIFY `MaPhieu` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
...
--
ALTER TABLE `thanhtoan`
  MODIFY `MaThanhToan` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
